...
describe("Geocoding service test suit", async () => {
  ...
  it("Fetches Zenpark address components from it's placeId", async () => {

    const service: GeocodingService = GeocodingService.instance;
  ...
  it("Fetches Zenpark address components from coordinates", async () => {
