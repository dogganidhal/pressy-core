...
export class BookingStatusUpdate extends StatusUpdate {
	...
	public static create(
		booking: Booking, type: BookingStatusUpdateType, doer: Person = booking.member.person,
		doerIdentity: BookingStatusUpdateDoerIdentity = BookingStatusUpdateDoerIdentity.MEMBER
	): BookingStatusUpdate {
